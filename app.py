...
#langchain é a principal biblioteca para orquestar tudo
...
load_dotenv() #vai chamar a chave da API, que está dentro o arquivo .env
...
if pdf_file:
    ...
    # É aqui que vai separar os blocos dos documentos, fazendo embeddings 
    splitter = CharacterTextSplitter(separator="\n", chunk_size=1000, chunk_overlap=100) # chunk_size=1000 para PDFs
    ...
    # === 4. Criação do Chain RAG === (Vai chamar a "OPENAI")
    retriever = vectorstore.as_retriever(search_type="similarity", search_kwargs={"k": 4}) #"k": 4 é a quantidade de clusters que estou especificando
